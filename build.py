...
OWNED_WEBSITES = [
    ...
    "https://artistweekly.com/how-dr-connor-robertson-automated-lead-generation-with-a-lean-intent-triggered-stack/",
]
...
PRESS_ARTICLES = [
    ...
    ("How Dr. Connor Robertson Builds a Content System That Publishes Without Daily Effort", "https://entertainmentpost.com/how-dr-connor-robertson-builds-a-content-system-that-publishes-without-daily-effort/", "Entertainment Post"),
    ("Dr. Connor Robertson Compares Zapier, Make, and n8n for Business Automation", "https://lawire.com/dr-connor-robertson-compares-zapier-make-and-n8n-for-business-automation/", "LA Wire"),
    ("Dr. Connor Robertson's Weekly Business Review System", "https://emonthlynews.com/dr-connor-robertsons-weekly-business-review-system/", "E Monthly News"),
    ("Dr. Connor Robertson on Building an Automated Reporting System That Delivers Itself Every Monday", "https://ceoweekly.com/dr-connor-robertson-on-building-an-automated-reporting-system-that-delivers-itself-every-monday/", "CEO Weekly"),
    ("Dr. Connor Robertson's Plain English Guide to APIs for Non-Technical Founders", "https://californiaobserver.com/dr-connor-robertsons-plain-english-guide-to-apis-for-non-technical-founders/", "California Observer"),
    ("Dr. Connor Robertson on Why Successful Entrepreneurs Focus on Systems, Not Goals", "https://kivodaily.com/entrepreneur/dr-connor-robertson-on-why-successful-entrepreneurs-focus-on-systems-not-goals/", "Kivo Daily"),
    ("Dr. Connor Robertson's AI Delegation Framework: What to Automate, Delegate, and Keep", "https://influencerdaily.com/dr-connor-robertsons-ai-delegation-framework-whatto-automate-delegate-and-keep/", "Influencer Daily"),
    ("How Dr. Connor Robertson Builds an SOP Library That Actually Gets Used", "https://economicinsider.com/how-dr-connor-robertson-builds-an-sop-library-that-actually-gets-used/", "Economic Insider"),
...
<div class="pod-card"><h3>Market Daily</h3><p>Featured for insights on training teams to integrate AI while preserving the human element.</p><a href="https://marketdaily.com/dr-connor-robertson-on-training-a-team-to-use-ai-without-losing-the-human-touch/" target="_blank" rel="noopener" class="pod-link">Read More &rarr;</a></div>
